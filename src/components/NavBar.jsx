...
>
  <button
    ...
    className="px-3 py-2 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-neutral-300"
  >
    Categorías
  </button>
  <div
    className={`absolute left-0 mt-2 ${catsOpen ? 'block' : 'hidden'} z-50 bg-white border rounded-md shadow-md max-h-[70vh] overflow-auto min-w-56`}
  >
    <ul className="py-2">
      {cats.map((c) => (
        <li key={c.id}>
